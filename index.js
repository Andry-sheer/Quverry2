...
$('#buttonOpen').val('click to show').css({'padding': '0 25px', 'height': '40px', 'margin-top':'50px', 'cursor':'pointer'});   //? запізно помітив що можна було робити через = { , : , : ,} 

$('#buttonClose').val('click to close').css('padding', '0 25px').css('height', '40px').css('margin-top','50px').css('cursor', 'pointer').css('display', 'none');
